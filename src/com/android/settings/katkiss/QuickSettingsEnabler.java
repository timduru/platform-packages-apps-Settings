...
public class QuickSettingsEnabler extends SwitchWidget {
    ...
    public void setState(Switch switch_) {
        boolean isEnabled = Settings.System.getInt(mContext.getContentResolver(), KKC.S.EXPANDED_VIEW_WIDGET, 0) == 1;
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        Settings.System.putInt(mContext.getContentResolver(), KKC.S.EXPANDED_VIEW_WIDGET,
                isChecked ? 1 : 0);
        return;
    }
