...
public abstract class ActionFragment extends SettingsPreferenceFragment {
    ...
    private void populateActionAdapter() {
        ...
        View dialog = View.inflate(mContext, R.layout.eos_activity_dialog, null);
    ...
    private class AppArrayAdapter extends ArrayAdapter {
        ...
        public AppArrayAdapter(Context context, List<AppPackage> objects) {
            super(context, R.layout.eos_activity_item, objects);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            itemRow = ((LayoutInflater) mContext
                    ...
                    .inflate(R.layout.eos_activity_item, null);
