...
public class LoggerPackages extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mListPackagesAdapter = new ActionsAdapter(getActivity(),
                R.layout.eos_privacy_logger_packages,
        ...
        try {
            BufferedReader reader = new BufferedReader(new FileReader(new File(getActivity()
                    .getDir("eos", Context.MODE_PRIVATE), PrivacySettings.UIDS_LIST_FILE)));
            String input = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.eos_logger_packages, container, false);
                ...
                case R.id.eos_lockscreen_actions_save:
                    ...
                    try {
                        writer = new BufferedWriter(new FileWriter(new File(
                                ...
                                PrivacySettings.UIDS_LIST_FILE)));
    ...
    private class ActionsAdapter extends ArrayAdapter<String> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (packageName == null || packageName.equals("")) packageName = "Select a package...";
