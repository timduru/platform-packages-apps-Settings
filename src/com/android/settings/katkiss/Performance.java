...
public class Performance extends PreferenceFragment implements
    ...
    private static final String FC_CATEGORY = "kk_settings_fast_charge";
    private static final String S2W_CATEGORY = "kk_settings_sweep2wake";
    private static final String ZRAM_CATEGORY = "kk_settings_zram";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.kk_performance_settings);

        mContext = (Context) getActivity();

        mClocksOnBootPreference = (CheckBoxPreference) findPreference("kk_performance_cpu_set_on_boot");
        ...
        mClocksMinPreference = (ListPreference) findPreference("kk_performance_cpu_min");
        mClocksMaxPreference = (ListPreference) findPreference("kk_performance_cpu_max");
        mClocksMinPreference.setOnPreferenceChangeListener(this);
        mClocksMaxPreference.setOnPreferenceChangeListener(this);

        mIoSchedPreference = (ListPreference) findPreference("kk_performance_iosched");
        mIoSchedPreference.setOnPreferenceChangeListener(this);

        mIoSchedOnBootPreference = (CheckBoxPreference) findPreference("kk_performance_iosched_on_boot");
        ...
        mClocksGovPreference = (ListPreference) findPreference("kk_performance_cpu_governor");
        ...
        if (!Utils.hasKernelFeature(Utils.FFC_PATH)) {
            ...
            mFastChargePreference = (CheckBoxPreference) findPreference("kk_performance_fast_charge");
        ...
        if (!Utils.hasKernelFeature(Utils.S2W_PATH)) {
            ...
            mEnableSweep2Wake = (CheckBoxPreference) findPreference("kk_performance_sweep2wake_enable");
            mEnableSweep2Wake.setOnPreferenceChangeListener(this);

            mSweep2WakeOnBoot = (CheckBoxPreference) findPreference("kk_performance_sweep2wake_set_on_boot");
        ...
        if (!Utils.hasKernelFeature(Utils.ZRAM)) {
            ...
            mZramPref = (CheckBoxPreference) findPreference("kk_performance_zram");
    ...
    private void updatePreferenceSummary(Preference preference, String currentValue,
        ...
        newSummary.append(getResources().getString(R.string.kk_performance_current_value));
        newSummary.append(" ");
        newSummary.append(currentValue);

        if (bootValue != null) {
            newSummary.append("\n");
            newSummary.append(getResources().getString(R.string.kk_performance_boot_value));
            newSummary.append("      ");
