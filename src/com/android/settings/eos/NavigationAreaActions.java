...
public class NavigationAreaActions extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.eos_navbar_settings);
        ...
        pc.setTitle(mHasNavBar ? R.string.eos_interface_navbar_appearance : R.string.eos_interface_systembar_appearance);
    ...
    public boolean onPreferenceClick(Preference pref) {
        ...
        if (pref.equals(mStockColor)) {
            Settings.System.putInt(mResolver, EOSConstants.SYSTEMUI_NAVBAR_COLOR, EOSConstants.SYSTEMUI_NAVKEY_COLOR_DEF);
        }
        return false;
    }
}
