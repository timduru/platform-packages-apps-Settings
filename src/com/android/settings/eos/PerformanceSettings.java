...
public class PerformanceSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.eos_performance_settings);
        ...
        try {
            ...
            mClocksGovPreference.setEntries(new String[] { "interactive", "ondemand" });
            mClocksGovPreference.setEntryValues(new String[] { "interactive", "ondemand" });
        }
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        if (preference.equals(mClocksOnBootPreference)) {
            ...
            try { updateCpuPreferenceValues(mClocksMinPreference, CLOCK_TYPE.MIN); }
            catch (Exception e) {}
            try { updateCpuPreferenceValues(mClocksMaxPreference, CLOCK_TYPE.MAX); }
            catch (Exception e) {}
            try { updateCpuPreferenceValues(mClocksGovPreference, CLOCK_TYPE.GOV); }
            catch (Exception e) {}
            return true;
            ...
            try {
                ...
                if (!writeToCpuFiles(clockType, output))
                    return false; // Writing the files failed, so don't proceed further.
     ...
     * 
     * @param fileName
     *            String of the file in the cpufrequency directory that you want
     *            to write to.
     * @param contents
     *            String of the contents you want to write.
        ...
        for (int i = 0; i < Runtime.getRuntime().availableProcessors(); i++) {
            ...
            try {
                ...
                try {
                    ...
                    return false; // We can't do anything if we hit an exception while closing.
                }
            }
        }
        return true;
