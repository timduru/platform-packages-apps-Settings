...
public class ClockActions extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.eos_clock_settings);
...
//        if (isTablet()) {
//            PreferenceCategory cat = (PreferenceCategory) findPreference("eos_statusbar_clock");
